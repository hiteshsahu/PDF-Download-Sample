...
public class DownloadTask extends AsyncTask<String, Integer, String> {
	...
	public DownloadTask(Context context, TextView errorConsole,
			File targetFile, String dialogMessage) {
